...
func setup(c *caddy.Controller) error {
	...
	mutex := sync.RWMutex{}
	m := MDNS{Domain: strings.TrimSuffix(domain, "."), minSRV: minSRV, filter: filter, bindIface: bindInface, mutex: &mutex, mdnsHosts: &mdnsHosts, srvHosts: &srvHosts, cnames: &cnames}
